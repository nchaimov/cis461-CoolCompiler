...
public class TypeChecker {
	...
	public Environment.CoolClass check(final Environment.CoolClass curClass,
		...
		if (node != null) {
			...
			case sym.DOT: {
				...
				final Environment.CoolMethod method = lookupMethod(
	...
	protected Environment.CoolMethod lookupMethod(Environment.CoolClass cls,
			final String id) {
	...
	protected Environment.CoolClass lookupAttr(Environment.CoolClass cls,
			final String id) throws TypeCheckException {
		if (id.equals("self")) {
